...
import { dispenserOpenSchema, DispenserOpenForm } from "@/types/inspection-forms";
...
export default function DispenserOpen() {
    ...
    const onSubmit = async (data: DispenserOpenForm) => {
        ...
        try {
            ...
            const linkFinalizar = `${window.location.origin}/formularios/dispenser/finalizar?protocolo=${protocol}`;
