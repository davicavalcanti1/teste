...
import { banheiroOpenSchema, BanheiroOpenForm } from "@/types/inspection-forms";
...
export default function BanheiroOpen() {
    ...
    const onSubmit = async (data: BanheiroOpenForm) => {
        ...
        try {
            ...
            // Webhook Logic
            const linkFinalizar = `${window.location.origin}/formularios/banheiro/finalizar?protocolo=${protocol}`;
