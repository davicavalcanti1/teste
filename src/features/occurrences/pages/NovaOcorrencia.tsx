...
import { ProtocolHeader } from "@/features/occurrences/components/forms/ProtocolHeader";
import { PatientDataBlock } from "@/features/occurrences/components/forms/PatientDataBlock";
import { OccurrenceDetailsBlock } from "@/features/occurrences/components/forms/OccurrenceDetailsBlock";
import { useToast } from "@/hooks/use-toast";
import { OccurrenceType, OccurrenceSubtype } from "@/features/occurrences/types/occurrence";
import { useCreateOccurrence } from "@/features/occurrences/hooks/useOccurrences";
...
const formSchema = z.object({
  paciente: z.object({
    ...
    telefone: z.string()
      .refine(
        (val) => val === "Não consta" || val.length >= 10,
        "Telefone inválido ou selecione 'Não consta'"
      ),
